...
//This is the way we use promises to do our task
...
//This does the work of promise in simple way
async function run(){
    ...
    await page.waitForSelector("a[data-attri='last']");
    ...
    for(let i = 1; i <= numPages; i++){
        ...
        if(i < numPages){
            ...
            await pageclick("a[data-attr1='Right']");
        }
    }
...
async function handleAllContestsOfApage(page, browser){
    ...
    for(let i = 0; i < curls.length; i++){
       ...
       await saveModeratorInContest(ctab, args.url+curls[i], config.moderators)
